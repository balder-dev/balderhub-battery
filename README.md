# BalderHub Package ``balderhub-battery``
...
```
python -m pip install balderhub-battery
```

# Check out the documentation

If you need more information, 
[checkout the ``balderhub-battery`` documentation](https://hub.balder.dev/projects/battery).
