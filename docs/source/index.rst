...
This is a BalderHub project that provides different kinds of features and scenarios to validate devices that use Batteries.

.. note::
   Please note, this package is still under development. If you would like to contribute, take a look into the
   `project <https://github.com/balder-dev/balderhub-battery/>`_.
